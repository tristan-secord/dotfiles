...
# Frontend Aliases
alias frontall="cd ~/Development/kiid && bin/nx lint web --max-warnings=0 && bin/nx format web --fix && bin/nx test web && bin/nx lint core --max-warnings=0 && bin/nx format core --fix && bin/nx test core && bin/nx format mobile --fix && bin/nx lint mobile --max-warnings=0 && bin/nx test mobile"
